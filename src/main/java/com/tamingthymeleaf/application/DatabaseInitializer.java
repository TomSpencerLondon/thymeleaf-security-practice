...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        final CreateUserParameters createUserParameters = new CreateUserParameters(
            new UserName("tom", "spencer"),
            "password",
            randomGender(), LocalDate.parse("2000-01-01"),
            new Email("tomspencerlondon@gmail.com"), new PhoneNumber("07885758652"));

        userService.createUser(createUserParameters);
